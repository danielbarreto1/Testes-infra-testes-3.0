...
resource "aws_security_group" "sg_iddev" {
...
resource "aws_security_group_rule" "ingress" {
  ...
  type              = "ingress"
  security_group_id = aws_security_group.sg_iddev[each.value.sg_name].id
  ...
  source_security_group_id = (
    ...
    aws_security_group.sg_iddev[each.value.rule.source_security_group_name].id :
    null
  )
}
